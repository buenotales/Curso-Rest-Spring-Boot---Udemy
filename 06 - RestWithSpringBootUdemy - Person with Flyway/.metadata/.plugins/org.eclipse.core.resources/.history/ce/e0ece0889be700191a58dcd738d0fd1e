...
public class MathController {
	...
	public Double sub (@PathVariable("value1") String n1, @PathVariable("value2") String n2) throws Exception {
	...
	public Double mult(@PathVariable("value1") String n1, @PathVariable("value2") String n2) throws Exception {
	...
	public Double div(@PathVariable("value1") String n1, @PathVariable("value2") String n2) throws Exception {
	...
	public Double raiz(@PathVariable("value1") String n) throws Exception {
